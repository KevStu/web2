...
<div id="id01" class="modal">
  <div id="form-update" class="modal-content">
    <div class="container">
      ...
      <form method="POST" id="itemForm" action="process/process_release.php?action=additem">
...
<form method="POST" id="itemSave" action="process/process_release.php?action=saveitem">
      <input type="hidden" id="relid" name="relid" value="<?php echo $id;?>"/>
      </form>
      <div id="form-update" class="modal-content">
    <div class="container">
